...
import Thesis from './images/Tiles/Thesis.jpg';
import { CSSTransition } from 'react-transition-group';
import UD from './images/Tiles/UD.png';
import BITS from './images/Tiles/BITS.jpg';
import Illustrations from './images/Tiles/Illustrations.jpg';
import NG from './images/Tiles/NG.jpg';
import Skjn from './images/Tiles/Skjn.jpg';
import DFH from './images/Tiles/DFH.jpg';
import OMA from './images/Tiles/OMA.jpg';
import Headshot from './images/Display.jpeg'
import Housing from './images/Tiles/Housing.jpg';
import {BrowserRouter as Router } from 'react-router-dom';
import Resume from './images/Resume.pdf'
import Route from 'react-router-dom/Route';
import Display from './images/Display.png';
import ThesisBody, {UdBody, OmaBody, IllustrationsBody, SkjnBody, HousingBody, DfhBody, NgBody, BitsBody} from './PageContent';
import ReactTransitionGroup from 'react-transition-group';
// Main page rendering routing to links
...
class Navbar extends Component {
  ...
  return(
    ...
    <li className="nav-item">
      <a className="nav-link text-secondary" href={Resume} target="_blank">Resume</a>
    </li>
    <li className="nav-item">
...
function Cover() {
    ...
    <div className = "container text-center mt-5">
      <img src = {Headshot} alt= "logo" className="text-center" style={{maxWidth: "30%"}}/>
            <p className="pb-0 mb-0 mt-3 text-muted">Hi, I am <strong>Shashank</strong>, and I</p>
            <h2 className="pt-0 mt-0"><strong style={{color:"red"}}>Design </strong> Solutions</h2>
    ...
    <div className="container mt-5">
      <div className="row">
        <div className="col-4 text-center">
          ...
          <img src={Display} className="rounded-circle border border-secondary" alt="Display" />  
          </div>
          <h3>Hello, nice to meet you.</h3>
          <p>I am Shashank, and I design experiences.</p>
          <a className="text-secondary" href={Resume} target="_blank">Download Resume</a>
        </div>
